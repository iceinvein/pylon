export const IPC = {
  ...
  GH_GET_REVIEW_SERIES: 'gh:get-review-series',
  GH_GET_REVIEW_THREADS: 'gh:get-review-threads',
  GH_GET_REVIEW_TIMELINE: 'gh:get-review-timeline',
  GH_GET_FINDING_POSTS: 'gh:get-finding-posts',
  GH_GET_REVIEW_RUN_FILES: 'gh:get-review-run-files',
