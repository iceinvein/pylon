...
export type CodeEntity =
  ...
  | {
      ...
      symbolId: string
      symbolName: string
      symbolType: AstNodeType
      startLine: number
      endLine: number
    }

export type ImpactEdgeKind = 'import' | 'reverse-import' | 'reference' | 'call' | 'test'

export type ImpactConfidence = 'high' | 'inferred' | 'unavailable'
